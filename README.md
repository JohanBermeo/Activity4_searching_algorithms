...
| **Tabla de Tiempos (Excel)** | Hoja de cálculo con gráficas de rendimiento empírico, comparativa de tiempos de ejecución según el tamaño del arreglo ($N$). | [Descargar Tablero de Métricas (XLSX)](https://github.com/JohanBermeo/Activity4_searching_algorithms/blob/algorithm/radix/RadixMetricas.xlsx) |
